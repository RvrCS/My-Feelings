package torres.river.myfeelings
...
import torres.river.myfeelings.graph.utilities.CustomBarDrawable
import torres.river.myfeelings.graph.utilities.CustomCircleDrawable
import torres.river.myfeelings.graph.utilities.Emociones
import torres.river.myfeelings.graph.utilities.JSONFile
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!data){
            ...
            graphHappy.background = CustomBarDrawable(this, Emociones("Feliz", 0.0F, R.color.colroAccent , happy))
    ...
    fun iconoMayoria(){
        ...
        if (neutral > veryHappy && neutral > happy && neutral > sad && neutral > verysad){
            icon.setImageDrawable(resources.getDrawable(R.drawable.baseline_sentiment_neutral_24))
        }
    ...
    fun actualizarGrafica(){
        ...
        lista.add(Emociones("Feliz", pH, R.color.colroAccent , happy))
        ...
        graphHappy.background = CustomBarDrawable(this, Emociones("Feliz", pH, R.color.colroAccent , happy))
